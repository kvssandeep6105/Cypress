Feature: End to End E-Commerce Flow
  ...
  @signup
  Scenario Outline: User Signup into the E-Commerce Application
    ...
    Examples:
      ...
      | SandeeP  | Saisandeepkunapureddy46789@gmail.com | Enter Account Information |
  ...
  Scenario Outline: Create an order with valid credentials
    ...
    Examples:
      ...
      | Saisandeepkunapureddy25@gmail.com | SandeeP@6105 | Pure Cotton Neon Green Tshirt | Your product has been added to cart. | Order Placed!       |
